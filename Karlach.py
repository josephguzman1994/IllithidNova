...
class PlotManager:
    ...
    def show_plots(self, x_cut, y_cut, blue_cut, red_cut, blue_unc_cut, red_unc_cut, color_filtered, cmd_label, red_label, blue_label, red_abs_cut_label, blue_abs_cut_label, red_unc_label, blue_unc_label, ra_filtered, dec_filtered, proximity_threshold, blue_abs_cut, red_abs_cut):
