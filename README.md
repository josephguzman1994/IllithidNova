...
<details>
  ...
  - `--plot_z_iso`: Reads in unpacked .npz files to  plot isochrones for varying metallicities and a fixed age.
  - `--plot_single_iso`: Reads in unpacked .npz file to plot a single isochrone for a given age and metallicity.
